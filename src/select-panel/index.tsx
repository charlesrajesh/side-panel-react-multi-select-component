...
const SelectPanel = ({ setExpanded }) => {
  ...
  const SidePanel = SidePanelComponent || Loading
          ...
          <div className="select-panel" role="listbox" ref={listRef}>
            {showSidePanelComponent ? 
              <div className="advanced-filter-div">
                <div className="advanced-filter-label" onClick={(e) => { setAdvancedFilterVisible(!isAdvancedFilterVisible) }}>
                  {sidePanelLabel}
                </div> 
              </div>
            : ''}
